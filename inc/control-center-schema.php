	...
	$sections = array(
		...
		'store' => array(
			...
			'fields'      => array(
				...
				'products_per_page'  => array( 'label' => __( 'Products per page override', 'funkycommerce-headless' ), 'type' => 'number', 'tier' => 'free', 'default' => '0', 'min' => '0', 'max' => '100', 'step' => '1', 'description' => __( '0 follows native WooCommerce products per row and rows per page. A positive value overrides both native and headless product archives.', 'funkycommerce-headless' ) ),
		...
		'build' => array(
			...
			'fields'      => array(
				...
				'build_provider'        => array( 'label' => __( 'Deployment provider', 'funkycommerce-headless' ), 'type' => 'select', 'tier' => 'free', 'default' => 'netlify', 'options' => array( 'netlify' => __( 'Netlify', 'funkycommerce-headless' ), 'cloudflare-pages' => __( 'Cloudflare Pages', 'funkycommerce-headless' ) ) ),
				'build_webhook_url'     => array( 'label' => __( 'Build webhook URL', 'funkycommerce-headless' ), 'type' => 'url', 'tier' => 'free', 'description' => __( 'Used by the Rebuild storefront action in the top admin bar. Static-first content changes are published only after this hook completes.', 'funkycommerce-headless' ) ),
				...
				'build_badge_id'        => array( 'label' => __( 'Netlify status badge site ID', 'funkycommerce-headless' ), 'type' => 'text', 'tier' => 'free', 'description' => __( 'Existing Netlify sites can keep using their site ID. Cloudflare Pages uses the status badge URL below instead.', 'funkycommerce-headless' ) ),
				'build_status_badge_url' => array( 'label' => __( 'Cloudflare Pages status badge URL', 'funkycommerce-headless' ), 'type' => 'url', 'tier' => 'free', 'default' => '', 'description' => __( 'Optional SVG badge URL for the Cloudflare Pages project. It appears in the top admin bar and refreshes every minute.', 'funkycommerce-headless' ) ),
				'build_dashboard_url'   => array( 'label' => __( 'Deployment dashboard URL', 'funkycommerce-headless' ), 'type' => 'url', 'tier' => 'free', 'default' => '', 'description' => __( 'Optional direct project dashboard URL. Netlify and Cloudflare Pages fall back to their provider dashboards.', 'funkycommerce-headless' ) ),
...
function funkycommerce_premium_companion_catalog() {
	$companions = array(
		...
		'superfunky-pro' => array(
			'name'         => __( 'Superfunky Pro', 'funkycommerce-headless' ),
			'product_id'   => 'theme-pro',
			'plugin_slugs' => array( 'superfunky-pro', 'funkycommerce-pro' ),
			'description'  => __( 'The premium companion that unlocks advanced theme controls and Pro storefront capabilities.', 'funkycommerce-headless' ),
			'product_url'  => 'https://codedletter.com/products/theme-pro/',
			'settings'     => array(
				__( 'Advanced Control Center options', 'funkycommerce-headless' ),
				__( 'Premium storefront presentation and operational controls', 'funkycommerce-headless' ),
				__( 'Licence-backed theme updates and support', 'funkycommerce-headless' ),
			),
		),
	);
