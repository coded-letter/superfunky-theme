	...
	$sections = array(
		...
		'build' => array(
			...
			'fields'      => array(
				...
				'build_badge_id'        => array( 'label' => __( 'Build status badge ID', 'funkycommerce-headless' ), 'type' => 'text', 'tier' => 'free', 'description' => __( 'For Netlify, enter the site ID to show its deploy status below Rebuild storefront in the admin bar.', 'funkycommerce-headless' ) ),
